...
{
    [self cbcache_setImageWithURL:url placeHolderImage:placeHolderImage withContext:nil];
}
...
{
    [self cbcache_setImageWithURL:url placeHolderImage:placeHolderImage withContext:context success:nil failure:nil];
}
...
{
    [self cbcache_setImageWithURL:url placeHolderImage:placeHolderImage withContext:nil success:success failure:failure];
}
                       ...
                       failure: (void (^) (NSError * error))failure
{
    ...
    [mySession setCacheContext: context];
